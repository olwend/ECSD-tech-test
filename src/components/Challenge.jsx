    ...
    <Paper className={"challenge"} style={paperStyle} zDepth={3}>
      ...
      <div>
        ...
        <p>
          ...
          write a function that is able to return the index of the array where the sum of integers at the indexes on the left is equal to the sum of integers on the right.</p>
